...
public class ClubActivityActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		backButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				ClubActivityActivity.this.finish();
			}
		});
		
		mListView = (ListView )findViewById(R.id.listViewclubactivityyes);
		mListView.setDividerHeight(0);
		Resources res = this.getResources();
        mlist = new ArrayList<ClubActivityActivity.ListItem>();  
        //添加某一项带图标的viewlist
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.club_activity, menu);
		return true;
	}
    ...
    class MainListViewAdapter extends BaseAdapter {  
        ...
        public View getView(int position, View convertView, ViewGroup parent) {  
            ...
            if (convertView == null) {  
                ...
                convertView = LayoutInflater.from(ClubActivityActivity .this).inflate(  
                        R.layout.items, null);  
